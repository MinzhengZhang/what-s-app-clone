...
export default function Signup() {
  ...
  const [data, setData] = useState<SignUpType>({
    ...
    password: "",
    confirmPassword: "",
    birthday: { day: 14, month: 9, year: 2022 },
  });
  useEffect(() => {
      ...
      createUserWithEmailAndPassword(auth, email, password)
        .then((user) => {
          const userData = {
            ...
            ], // user can search other user according to search list
          };
          ...
          addDoc(collection(db, "chats"), {
            ...
            addDoc(collection(db, "messages"), {
              chatId: docRef.id,
              message:
                "Hello i'm xxxxx, thanks for connecting",
    ...
    <div className="grid w-full text-gray-900 grid-cols-5 font-jakarta h-screen">
      <div className="bg-green hidden lg:flex overflow-hidden w-full col-span-2 flex-col items-center justify-center">
        <h1 className="font-medium text-white text-lg tracking-wider text-center max-w-md">
          This is just a simple demo for what's app clone. Thanks for browsing this website. Just register and explore it !. 
        </h1>
                ...
                <div className="relative" ref={calendarRef}>
                  ...
                  {openCalendar && (
                    <div className="absolute -right-20 sm:right-10 -top-52">
                      <Calendar
                        maximumDate={{ year: 2022, month: 12, day: 31 }}
                        minimumDate={{ year: 1900, month: 1, day: 1 }}
                        colorPrimary="#128C7E"
                        value={data.birthday}
